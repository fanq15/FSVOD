...
class FsodFastRCNNOutputs(object):
    ...
    def __init__(
        ...
        self.loss_smooth = CrossEntropyLabelSmooth(2)
    ...
    def softmax_cross_entropy_loss(self):
        ...
        #print(self.gt_classes[topk_inds])
        #return F.cross_entropy(self.pred_class_logits[topk_inds], self.gt_classes[topk_inds]) #, reduction="mean")
        return self.loss_smooth(self.pred_class_logits[topk_inds], self.gt_classes[topk_inds]) #, reduction="mean")
    ...
    def losses(self):
        ...
        """
        return {
            "relation_loss_cls": self.softmax_cross_entropy_loss(),
            "relation_loss_box_reg": self.smooth_l1_loss(),
        }

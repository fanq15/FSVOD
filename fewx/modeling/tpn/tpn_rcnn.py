...
class TpnRCNN(nn.Module):
    ...
    def relation_model(self, batched_inputs):
        ...
        offline_support_file_name = './support_dir/offline_fsvod_val_support_feature_' + str(self.seed_id) +  '.pkl'
        offline_support_path = './datasets/fsvod/support_df_dir/offline_fsvod_val_support_df_' + str(self.seed_id) + '.pkl'
        ...
        if not os.path.exists(offline_support_file_name):
            ...
            online_support_path = './datasets/fsvod/support_df_dir/online_fsvod_val_support_df_' + str(self.seed_id) + '.pkl'
            offline_support_path = './datasets/fsvod/support_df_dir/offline_fsvod_val_support_df_' + str(self.seed_id) + '.pkl'

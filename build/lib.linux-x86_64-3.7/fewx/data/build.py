...
from detectron2.data.build import build_batch_data_loader, load_proposals_into_dataset, filter_images_with_few_keypoints, print_instances_class_histogram, trivial_batch_collator, get_detection_dataset_dicts
...
def build_detection_test_loader(cfg, dataset_name, mapper=None):
    ...
    if mapper is None:
        mapper = GTDatasetMapper(cfg, False) #True)
    dataset = MapDataset(dataset, mapper)

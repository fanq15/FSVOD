...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions, gt_instances):
        """
        ...
        ori_gt_boxes = gt_instances['bbox']
        gt_boxes_0 = ori_gt_boxes[0]
        gt_boxes_1 = ori_gt_boxes[1]
        gt_boxes_2 = ori_gt_boxes[0] + ori_gt_boxes[2]
        gt_boxes_3 = ori_gt_boxes[1] + ori_gt_boxes[3]
        gt_boxes = Boxes([[gt_boxes_0, gt_boxes_1, gt_boxes_2, gt_boxes_3]])
        gt_scores = [100]
        gt_classes = [gt_instances['category_id']]
        gt_labels = _create_text_labels(gt_classes, gt_scores, self.metadata.get("thing_classes", None))
        labels = gt_labels + labels
        boxes = Boxes.cat([gt_boxes, boxes])

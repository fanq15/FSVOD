...
def main():
    ...
    annFile = os.path.join(root_path, 'annotations/support_fsvod_test.json') #'new_annotations/final_split_non_voc_instances_train2017.json')
...
if __name__ == '__main__':
    since = time.time()
    support_df = main()
    support_df.to_pickle("./fsvod_test_support_df.pkl")

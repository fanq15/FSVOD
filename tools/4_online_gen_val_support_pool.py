...
def main():
    ...
    annFile = os.path.join(root_path, 'annotations/online_support_fsvod_val.json') #'new_annotations/final_split_non_voc_instances_train2017.json')
...
if __name__ == '__main__':
    since = time.time()
    support_df = main()
    support_df.to_pickle("./online_fsvod_val_support_df.pkl")
